...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/agora.jpg
  AssetGenImage get agora => const AssetGenImage('assets/images/agora.jpg');
  ...
  /// File path: assets/images/imagotipo.png
  AssetGenImage get imagotipo =>
      const AssetGenImage('assets/images/imagotipo.png');

  /// File path: assets/images/logotipo.png
  AssetGenImage get logotipo =>
      const AssetGenImage('assets/images/logotipo.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [agora, avatar1, avatar2, avatar3, avatar4, imagotipo, logotipo];
}
